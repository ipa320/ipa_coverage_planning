...
//		writeToGlobalFiles(map_names, data_storage_path, map_pathlengths, map_cleaning_times, sequence_solver_times);
	...
	void setConfigurations(std::vector< EvaluationConfig >& evaluation_configurations)
	{
		...
		{
			for (double max_clique_path_length = 10.; max_clique_path_length <= 16.; max_clique_path_length += 2.0)
			{
				for (int room_segmentation_algorithm=1; room_segmentation_algorithm<=2; ++room_segmentation_algorithm)
				{
